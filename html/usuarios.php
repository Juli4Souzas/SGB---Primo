...
if(!empty($_GET['search']))
    {
        ...
        cd_usuario LIKE '%$data%' or
        nm_email LIKE '%$data%' or 
        nm_nome_usuario LIKE '%$data%' or  
        nm_nome LIKE '%$data%' ORDER BY cd_usuario DESC";
    }
    else
    {
...
<body>
  ...
  <h3>Usuários</h3><hr>
    <div class="cima">
    <a href="cadastro_emprestimo.php"><button type="button" class="btn btn-dark adicionar">+ Usuário</button></a>
  ...
  <br>
      ...
      <tbody  class="">
        <?php
          ...
          {
            echo "<tr>";
            echo "<td>".$user_data['cd_usuario']."</td>";
            echo "<td>".$user_data['nm_nome']."</td>";
            echo "<td>".$user_data['tel_telefone']."</td>";
            echo "<td>".$user_data['nm_email']."</td>";
            echo "<td>".$user_data['nm_nome_usuario']."</td>";
            echo "<td>".$user_data['nm_senha']."</td>";
            echo "<td>
            <a class='btn btn-sm btn-primary' href='edit_usuario.php?cd_usuario=$user_data[cd_usuario]'>
            <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil' viewBox='0 0 16 16'>
               <path d='M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z' />
             </svg>
             </a>
             <a class='btn btn-sm btn-danger' href='delete2.php?cd_usuario=$user_data[cd_usuario]' title='Deletar'>
