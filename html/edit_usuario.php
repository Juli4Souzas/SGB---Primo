<?php
    ...
    if(!empty($_GET['cd_usuario']))
    {
        ...
        if($result->num_rows > 0)
        {
            ...
            {
                $nm_nome = $user_data["nm_nome"];
                $tel_telefone = $user_data["tel_telefone"];
                $nm_email = $user_data["nm_email"];
                $nm_senha = $user_data["nm_senha"];
...
<!---->
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
            <h3>Cadastro</h3>
            <p class="blue-text">Cadastre-se para ter mais benefícios<br> Nenhuma das inforções a seguir será divulgada para outros meios</p>
            <div class="card">
                <h5 class="text-center mb-4">Preencha os campos a seguir</h5>
                <form action="saveEdit_usuario.php" method="post" class="form-card">

                    <div class="row justify-content-between text-left">
                        <div class="form-group col-sm-6 flex-column d-flex"> 
                            <label class="form-control-label px-3">Nome completo<span class="text-danger"> *</span></label> 
                            <input type="text" class="input" id="nm_nome" name="nm_nome" value="<?php echo $nm_nome;?>" required> 
                        </div>

                        <div class="form-group col-sm-6 flex-column d-flex"> 
                            <label class="form-control-label px-3">Telefone<span class="text-danger"> *</span></label> 
                            <input type="text" class="input" id="tel_telefone" name="tel_telefone" maxlength="11" value="<?php echo $tel_telefone;?>" required> 
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-between text-left">
                        <div class="form-group col-sm-6 flex-column d-flex"> 
                            ...
                            <input type="text" id="nm_email" name="nm_email" class="input" value="<?php echo $nm_email;?>" required> 
                        </div>

                        <div class="form-group col-sm-6 flex-column d-flex"> 
                            <label class="form-control-label px-3">Nome de usuário(Até 15 digitos)<span class="text-danger"> *</span></label> 
                            <input type="text" id="nm_nome_usuario" name="nm_nome_usuario" class="input" maxlength="15" value="<?php echo $nm_nome_usuario;?>" required> 
                        </div>
                    </div>

                    <div class="row justify-content-between text-left">
                        <div class="form-group col-sm-6 flex-column d-flex"> 
                        <label class="form-control-label px-3">Senha(8 digitos)<span class="text-danger"> *</span></label> 
                            <input type="password" id="nm_senha" name="nm_senha" class="input" maxlength="8" value="<?php echo $nm_senha;?>" required>  
                        </div>
                        <div class="form-group col-sm-6 flex-column d-flex"> 
                            
                            <input type="hidden" name="cd_usuario" value="<?php echo $cd_usuario;?>">
                        </div>
                    </div>
