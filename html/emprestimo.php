...
if(!empty($_GET['search']))
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM tb_emprestimo_livro WHERE 
        cd_emprestimo_livro LIKE '%$data%' or
        nm_titulo LIKE '%$data%' or 
        nm_nome_usuario LIKE '%$data%' ORDER BY cd_emprestimo_livro DESC";
    }
    else
    {
        $sql = "SELECT * FROM tb_emprestimo_livro ORDER BY cd_emprestimo_livro DESC";
    }
...
<body>
    ...
    <a href="index_logado_adm.php"class="fas fa-home"></a>
      ...
      <!--CONTEÚDO--><br><br>
      <div class="container">
  <h3>Empréstimos</h3><hr>
    <div class="cima">
    <a href="cadastro_emprestimo.php"><button type="button" class="btn btn-dark devolucoes">Empréstimo</button></a>
...
<div class="box-search"><br>
  ...
  <br>
      ...
      <tbody  class="">
        <?php
          ...
          {
            echo "<tr>";
            echo "<td>".$user_data['cd_emprestimo_livro']."</td>";
            ...
            <a class='btn btn-sm btn-success' href='cadastro_historico.php?cd_emprestimo_livro=$user_data[cd_emprestimo_livro]'>
  ...
  <path d='M15.354 3.354a.5.5 0 0 0-.708-.708L8 9.293 5.354 6.646a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l7-7z'/>
             ...
             <a class='btn btn-sm btn-danger' href='delete3.php?cd_emprestimo_livro=$user_data[cd_emprestimo_livro]' title='Deletar'>
...
function searchData()
{
    window.location = 'emprestimo.php?search='+search.value;
}
</script>
