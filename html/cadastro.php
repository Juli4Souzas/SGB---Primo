    ...
    <div class="row d-flex justify-content-center">
        <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
            ...
            <div class="card">
                ...
                <form action="guardar_cadastro.php" method="post" class="form-card">

                    <div class="row justify-content-between text-left">
                        <div class="form-group col-sm-6 flex-column d-flex"> 
                            <label class="form-control-label px-3">Nome completo<span class="text-danger"> *</span></label> 
                            <input type="text" class="input" id="nm_nome" name="nm_nome" required> 
                        </div>

                        <div class="form-group col-sm-6 flex-column d-flex"> 
                            <label class="form-control-label px-3">Telefone<span class="text-danger"> *</span></label> 
                            <input type="text" class="input" id="tel_telefone" name="tel_telefone" maxlength="11" required> 
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-between text-left">
                        <div class="form-group col-sm-6 flex-column d-flex"> 
                            ...
                            <input type="text" id="nm_email" name="nm_email" class="input" required> 
                        </div>

                        <div class="form-group col-sm-6 flex-column d-flex"> 
                            <label class="form-control-label px-3">Nome de usuário(Até 15 digitos)<span class="text-danger"> *</span></label> 
                            <input type="text" id="nm_nome_usuario" name="nm_nome_usuario" class="input" maxlength="15" required> 
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-between text-left">
                        ...
                        <label class="form-control-label px-3">Senha(8 digitos)<span class="text-danger"> *</span></label> 
                            <input type="password" id="nm_senha" name="nm_senha" class="input" maxlength="8" required>  
                        </div>
                    ...
                    <div class="bot">
                        <div class="form-group col-sm-6"> 
                            <button type="submit"value="salvar" class="btn-block btn-primary">Cadastrar</button> 
                        </div>
                    </div>
                </form>
            </div>
